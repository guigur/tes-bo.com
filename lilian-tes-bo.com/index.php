...
<div style="position: absolute; left: 50%;">
    <div style="position: relative; left: -50%; 1px; z-index: 1000">
        <audio controls autoplay>
            <source src="music/Enya - Who can say.mp3" type="audio/mp3">
            Your browser does not support the audio element.
        </audio>
    </div>
</div>
<div id="bg"><a href="#" class="nextImageBtn" title="next"></a><a href="#" class="prevImageBtn" title="previous"></a><img src="lilian%20tes%20bo%20bg.png" width="1680" height="1050"  id="bgimg" /></div>
<div id="preloader"><img src="ajax-loader_dark.gif" width="32" height="32" /></div>
<div id="img_title"></div>
<div id="toolbar"><a href="#" title="Maximize" onClick="ImageViewMode('original');return false"><img src="toolbar_fs_icon.png" width="50" height="50"  /></a></div>
...
$dir    = 'lilians';
$files1 = scandir($dir);
foreach($files1 as &$ca)
{
$type = pathinfo($dir.'/'.$ca, PATHINFO_EXTENSION);
if ($type == "jpeg" || $type == "jpg" || $type == "png" || $type == "gif" || $type == "JPEG" || $type == "JPG" || $type == "PNG" || $type == "GIF") {
    echo '<div class="content">';
    echo'<div><a href="lilians/'.$ca.'"><img src="lilians/'.$ca.'" height="140px" title="'.$ca.'" alt="'.$ca.'" class="thumb" /></a></div>';
    echo '</div>';
}
}
?>
